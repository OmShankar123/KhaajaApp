...
const RegisterPhoneScreen = (props) => {
  const [selectedCountry, setSelectedCountry] = useState(
    CountryCode.find(country => country.name === 'Nepal'),
  );
  ...
  return (
    <View
      ...
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.headerTitle}>Login into Khaaja</Text>
      </View>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        onPress={() => props.navigation.navigate('Verification', {phoneNumber},)}>
